...
"""Tests for partner_time_to_pay module."""
...
class TestPartnerTimeToPay(TransactionCase):
    """Test suite for Partner Time to Pay statistics."""

    def setUp(self):
        """Set up test fixtures: partner, product, accounts, invoice, and payment."""
        super().setUp()
    ...
    def test_partner_compute_d2x(self):
        """Test that D2X computations are idempotent and distinct."""
